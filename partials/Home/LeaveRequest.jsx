...
export default function LeaveRequest() {
    return (
        <div className="request my-20" id="contact">
            <div className="container flex flex-col items-center px-6 sm:px-10 md:px-16 lg:mx-auto">
                ...
                <p className="text mt-4 font-light text-black text-center text-sm max-w-md" data-aos="fade-down">
                ...
                <a href="mailto:jensderyckere@icloud.com" className="link flex items-center mt-4">
